...
Usage:
    python query.py "Note: had great idea about X"
    python query.py "Add to today: met with Sarah"
    python query.py "What did I note about Canadian?"
"""
...
- Be concise and format for Telegram (brief, clear, minimal emoji)
